//This is to create virtual network resources in Azure using Bicep. This VNet's main purpose is for my DevOps VM that will house all of my DevOps tools and resources.
